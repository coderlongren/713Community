...
<head>
    ...
    <meta name="keywords" content="713社区">
</head>
<body>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2" id="menu-box">
        <c:forEach var="menu" items="${menu}">
        <dl>
            <dt><i class="Hui-iconfont">${menu.icon}</i> ${menu.menuName}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <c:forEach var="column" items="${columns}">
                        <c:if test="${column.parentId == menu.menuId}">
                             <li><a _href="${column.url}" data-title="${column.menuName}" href="javascript:void(0)">${column.menuName}</a></li>
                        </c:if>
                    </c:forEach>
                </ul>
            </dd>
